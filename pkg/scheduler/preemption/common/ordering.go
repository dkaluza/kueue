...
// QuotaReservationTime returns the time when quota was reserved for the workload.
// If the WorkloadQuotaReserved condition is missing or not True, returns now.
